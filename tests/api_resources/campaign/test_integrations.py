...
from growsurf.types.campaign import IntegrationListResponse
...
class TestIntegrations:
    ...
    def test_method_list(self, client: Growsurf) -> None:
        integration = client.campaign.integrations.list(
            "id",
        )
    ...
    def test_raw_response_list(self, client: Growsurf) -> None:
        response = client.campaign.integrations.with_raw_response.list(
            "id",
        )
    ...
    def test_streaming_response_list(self, client: Growsurf) -> None:
        with client.campaign.integrations.with_streaming_response.list(
            "id",
        ) as response:
    ...
    def test_path_params_list(self, client: Growsurf) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.campaign.integrations.with_raw_response.list(
                "",
            )
...
class TestAsyncIntegrations:
    ...
    async def test_method_list(self, async_client: AsyncGrowsurf) -> None:
        integration = await async_client.campaign.integrations.list(
            "id",
        )
        assert_matches_type(IntegrationListResponse, integration, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncGrowsurf) -> None:
        response = await async_client.campaign.integrations.with_raw_response.list(
            "id",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncGrowsurf) -> None:
        async with async_client.campaign.integrations.with_streaming_response.list(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncGrowsurf) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.campaign.integrations.with_raw_response.list(
                "",
            )
