...
class TestInstallation:
    ...
    def test_method_retrieve(self, client: Growsurf) -> None:
        installation = client.campaign.installation.retrieve(
            "id",
        )
        assert_matches_type(CampaignInstallation, installation, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_retrieve(self, client: Growsurf) -> None:
        response = client.campaign.installation.with_raw_response.retrieve(
            "id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Growsurf) -> None:
        with client.campaign.installation.with_streaming_response.retrieve(
            "id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Growsurf) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.campaign.installation.with_raw_response.retrieve(
                "",
            )
    ...
    def test_method_update(self, client: Growsurf) -> None:
        installation = client.campaign.installation.update(
            id="id",
            body={"foo": "bar"},
        )
        assert_matches_type(CampaignInstallation, installation, path=["response"])
    ...
    def test_raw_response_update(self, client: Growsurf) -> None:
        response = client.campaign.installation.with_raw_response.update(
            id="id",
            body={"foo": "bar"},
        )
    ...
    def test_streaming_response_update(self, client: Growsurf) -> None:
        with client.campaign.installation.with_streaming_response.update(
            id="id",
            body={"foo": "bar"},
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_update(self, client: Growsurf) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.campaign.installation.with_raw_response.update(
                id="",
                body={"foo": "bar"},
            )


class TestAsyncInstallation:
    ...
    async def test_method_retrieve(self, async_client: AsyncGrowsurf) -> None:
        installation = await async_client.campaign.installation.retrieve(
            "id",
        )
        assert_matches_type(CampaignInstallation, installation, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncGrowsurf) -> None:
        response = await async_client.campaign.installation.with_raw_response.retrieve(
            "id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncGrowsurf) -> None:
        async with async_client.campaign.installation.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncGrowsurf) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.campaign.installation.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_method_update(self, async_client: AsyncGrowsurf) -> None:
        installation = await async_client.campaign.installation.update(
            id="id",
            body={"foo": "bar"},
        )
        assert_matches_type(CampaignInstallation, installation, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncGrowsurf) -> None:
        response = await async_client.campaign.installation.with_raw_response.update(
            id="id",
            body={"foo": "bar"},
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncGrowsurf) -> None:
        async with async_client.campaign.installation.with_streaming_response.update(
            id="id",
            body={"foo": "bar"},
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update(self, async_client: AsyncGrowsurf) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.campaign.installation.with_raw_response.update(
                id="",
                body={"foo": "bar"},
            )
